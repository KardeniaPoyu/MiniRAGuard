# 🏡 租房合同智能审查助手 - 项目白皮书 (MVP 修正版) 🏡

> 数据契约对齐：`docs/青居智选_技术文档_v1.6.md`

---

## 💡 一、 它是干什么的？（原理大白话）

普通人看不懂租房合同里的法律套路，我们的系统充当一个**“全天候智能法律顾问”**。为了确保结论绝对权威，我们将过程拆解为三步：
...
2. **⚖️ 第二步：翻书找法条 (RAG 检索增强)**
   - **干啥**：系统在后台翻阅中国《民法典》、《租房管理条例》词典，专门挑出和“押金、转租”等关键词相关的标准法律条文，防止大模型发生“幻觉”乱说。
